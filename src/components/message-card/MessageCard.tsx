        ...
        <AccordionContent className="border-black py-3">
          <Card className="p-3 md:p-6">
            <CardContent className="text-base md:text-lg">
              <div className="border-b border-black font-hypatiaSemibold capitalize">
              ...
              {message.formType === "event" && (
                <div className="border-b border-black py-3 font-hypatiaSemibold capitalize">
                  <h3 className="mb-3 text-center font-bigola text-xl">
                    {eventType}
                  </h3>
                  <div className="mb-3 flex w-full items-center justify-between">
                    <CalendarBlank size={36} weight="duotone" />
                    <p> {message.eventDate}</p>
                  </div>
                  <div className="mb-3 flex w-full items-center justify-between">
              ...
              <div className="flex w-full flex-col border-b border-black pb-3 font-hypatia">
                <div className="flex w-full items-center justify-between py-3">
                  <ChatCircle size={36} weight="duotone" />
                </div>
                <p className="text-center">"{message.message.trim()}"</p>
              </div>
