          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="w-full">
                ...
                <FormControl className="border border-customNavy font-bigola text-customNavy focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-customGold">
                  <DatePicker
                    value={field.value}
