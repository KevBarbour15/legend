...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap border text-lg transition-all duration-300 disabled:opacity-50 rounded-sm lg:hover:rounded-2xl",
  {
    variants: {
      variant: {
        default: "",
