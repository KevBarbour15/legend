  ...
  return (
    ...
    >
      <div className="flex flex-grow flex-col justify-start pl-6 pt-6">
        <img
          className="mb-6 w-[175px] drop-shadow-text md:hidden"
          src="./images/alt-logo.png"
          alt="Logo"
        />
        <ul
          className="font-bigola text-4xl uppercase drop-shadow-text"
          id="menu-text"
        >
          {links.map((link, idx) => (
      ...
      <div className="mb-24 ml-6 w-fit font-bigola drop-shadow-text">
        <a
        ...
        >
          ...
          <p id="menu-text" className="flex justify-between text-3xl">
            <span>S</span>
            <span>a</span>
            <span>c</span>
            <span>r</span>
